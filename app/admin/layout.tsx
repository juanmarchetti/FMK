...
const navItems = [
  ...
  { href: "/admin/normativa", label: "Configuración", icon: "settings" },
  { href: "/admin/estilos", label: "Estilos", icon: "palette" },
  { href: "/admin/katas", label: "Katas", icon: "sports_martial_arts" },
  { href: "/admin/auditoria", label: "Auditoría", icon: "history" },
  { href: "/admin/actas", label: "Actas", icon: "assignment" },
];
